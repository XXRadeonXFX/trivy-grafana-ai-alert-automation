...
Check out my Grafana dashboard [reference]: https://grafana.thakurprince.com](https://grafana.thakurprince.com/d/build-dashboard/build-dashboard?orgId=1&from=now-1h&to=now&timezone=browser&var-build_id=4&refresh=30s
